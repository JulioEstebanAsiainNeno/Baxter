...
class Board:
	...
	self.piecePrise = piecePrise
        ...
        # Moving piece
        self.cases[arrivee]=self.cases[depart] #La casilla a la que se movio la pieza, contiene el valor de la casilla en la que estaba la pieza antes de moverse (Antes de moverse: E1 es algo y E2 es torre. Despues de moverse: E1 es torre y E2 es casilla vacia)
        self.cases[depart]=Piece() #La casilla de la pieza que se movio queda vacia
        self.ply+=1
        ...
        # a KING has been moved-----------------------------------------
            ...
            if(pieceDeplacee.couleur=='blanc'):    
                ...
                if(depart==60):
                    ...
                    if(arrivee==58):
                        self.cases[56]=Piece()
			self.castle_pos1 = self.cases[56]
                        self.cases[59]=Piece('TOUR','blanc')
			self.castle_pos2 = self.cases[59]

                    elif(arrivee==62):
                        self.cases[63]=Piece()
			self.castle_pos1 = self.cases[63]
                        self.cases[61]=Piece('TOUR','blanc')
			self.castle_pos2 = self.cases[61]
            ...
            # Black KING
                ...
                if(depart==4):
                    ...
                    if(arrivee==6):
                        self.cases[7]=Piece()
			self.castle_pos1 = self.cases[7]
                        self.cases[5]=Piece('TOUR','noir')
			self.castle_pos2 = self.cases[5]

                    elif(arrivee==2):
                        self.cases[0]=Piece()
			self.castle_pos1 = self.cases[0]
                        self.cases[3]=Piece('TOUR','noir')   
			self.castle_pos2 = self.cases[3]           
    ...
    def get_piecePrise(self):
	return self.piecePrise

    ####################################################################
   
    def get_castle_pos1(self):
	return self.castle_pos1

    ####################################################################
    
    def get_castle_pos2(self):
	return self.castle_pos2
    ...
    def render(self):
        ...
        for piece in self.cases:
            if(piece.couleur=='noir'):
                print piece.nom[0].lower() + '  ', #print(piece.nom[0].lower(),end='   ')
            else:
                print piece.nom[0] + '  ', #print(piece.nom[0],end='   ')
                                    
            if(i%8==0):
                print
                print
                if(y>0):
                    print str(y) + '  ', #print(str(y),end='   ')
                y=y-1
        ...
        no_castle_right=True
        print 'Castle rights : ', #print('Castle rights : ',end='')
        if(self.white_can_castle_63):
            print 'K', #print('K',end='')
            no_castle_right=False
        if(self.white_can_castle_56):
    ...
    def showHistory(self):
        ...
        roque7) in self.history:
            ...
            if(promote!=''):
                b=b+promote
            if(aff==True):
                print "{}.{}{} ".format(int(cpt),a,b), #print("{}.{}{} ".format(int(cpt),a,b),end=' ')
                aff=False
            else:
                print "{}{} ".format(a,b), #print("{}{} ".format(a,b),end=' ')
                aff=True
            cpt+=0.5
        print
        print
