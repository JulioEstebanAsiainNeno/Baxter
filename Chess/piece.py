...
class Piece:
    ...
    # Name of the pieces
    nomPiece=(VIDE,'ROI','DAME','TOUR','CAVALIER','FOU','PION') #Nada, Rey, Reina, Torre, Caballo, Alfil, Peon
    ...
    deplacements_tour=(-10,10,-1,1) #Tipos de movimiento (arriba, abajo, izquierda, derecha). Deplacements -> Move
    deplacements_fou=(-11,-9,11,9) #Tipos de movimiento (DArI, DArD, DAbD, DAbI)
    deplacements_cavalier=(-12,-21,-19,-8,12,21,19,8) #Tipos de movimiento (......)
    # KING and QUEEN = BISHOP + ROOK !  #8 direcciones
    ...
    def pos2_roi(self,pos1,cAd,echiquier,dontCallIsAttacked=False): #Echiquier -> Chessboard
        ...
        if(couleur=='blanc'):
            ...
            if(echiquier.ROW(pos1)==6):
                ...
                if(echiquier.cases[pos1-8].isEmpty() and echiquier.cases[pos1-16].isEmpty()):
                    liste.append((pos1,pos1-16,'')) #Avanza 2
